  ...
  render() {
    return (
      <div className="page__content">
        ...
        <PopupWithForm name="update" title="Обновить аватар" buttonText="Сохранить" isOpen={this.state.isEditAvatarPopupOpen} onClose={this.closeAllPopups}>
        ...
        <PopupWithForm name="add" title="Новое место" buttonText="Добавить" isOpen={this.state.isAddPlacePopupOpen} onClose={this.closeAllPopups}>
